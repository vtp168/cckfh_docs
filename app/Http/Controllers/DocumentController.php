...
class DocumentController extends Controller
{
    ...
    public function __construct(
        ...
        DocumentCommentRepositoryInterface $documentCommentRepository
    ) {
    ...
    public function getDcoumentByIdWithComments($id)
    {
        $comment=$this->documentCommentRepository->getDocumentComment($id);
        $docs=$this->documentRepository->getDocumentbyId($id);
        $docs['comments']=$comment;
